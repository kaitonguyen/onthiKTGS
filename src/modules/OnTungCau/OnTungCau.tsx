        ...
        <>
            {
                showResult ? (
                    <>
                        <div className='p-6 my-6 mx-auto container bg-white shadow rounded'>
                    ...
                    <>
...

                        {
                            start && isRight !== undefined ?
                                (
                                    <div className={clsx("p-6 my-6 mx-auto container shadow rounded text-white bg-contain bg-right bg-no-repeat",
                                        {
