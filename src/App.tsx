      ...
      <div className="h-full overflow-y-scroll bg-white dark:bg-slate-700">
        <div id="kn-main-nav" className="shadow sticky">
          <div className="px-6 py-2 h-16 flex items-center justify-between dark:border-b container mx-auto">
            ...
            <div className="hidden md:flex items-center justify-between space-x-2">
              <div>
                <button
                  ...
                  onClick={() => setPage(1)}
                  className={clsx(
                    "capitalize inline-flex justify-center items-center rounded-lg text-sm font-semibold py-3 px-4 text-slate-900 dark:text-white ring-1 ring-slate-900/10 hover:bg-gray-300 hover:ring-slate-900/15 hover:text-slate-900",
                    {
              ...
              <div>
                <button
                  ...
                  onClick={() => setPage(2)}
                  className={clsx(
                    "capitalize inline-flex justify-center items-center rounded-lg text-sm font-semibold py-3 px-4 text-slate-900 dark:text-white ring-1 ring-slate-900/10 hover:bg-gray-300 hover:ring-slate-900/15",
                    {
              ...
              <div>
                ...
                >
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="icon icon-tabler icons-tabler-outline icon-tabler-wallpaper"
                  >
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            ...
            <button
              className={clsx(
                "justify-center items-center rounded-lg text-sm font-semibold py-3 px-4 text-white ring-1 ring-slate-900/10 bg-sky-600 hover:bg-sky-800 hover:ring-slate-900/15 inline-flex md:hidden"
              )}
            ...
            <div className="flex flex-col dark:divide-y border-b">
              <div>
                <button
                  ...
                  onClick={() => setPage(1)}
                  className={clsx(
                    "w-full capitalize inline-flex justify-center items-center text-sm font-semibold py-3 px-4 text-slate-900 dark:text-white ring-1 ring-slate-900/10 hover:ring-slate-900/15",
                    {
                      "bg-sky-600 text-white": page === 1,
                    }
                  )}
